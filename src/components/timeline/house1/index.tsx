...
const House1Timeline = () => {
    return (
        <Timeline title="House 1">
            <TimelineItem title="Offer accepted" startDate="2021/05/11">
            ...
            <TimelineItem title="Mortgage approved" startDate="2021/06/03">
                <p>
            ...
            <TimelineItem title="Seller has found a house" startDate="2021/06/15">
                <p>
            ...
            <TimelineItem title="Seller pulled out of onward purchase" startDate="2021/06/24">
                <p>
            ...
            <TimelineItem title="Seller has found another house" startDate="2021/08/17">
                <p>
            ...
            <TimelineItem title="Seller pulled out of onward purchase again" startDate="2021/11/02">
                <p>
            ...
            <TimelineItem title="Mortgage offer expired" startDate="2021/12/04">
                <p>
            ...
            <TimelineItem title="Seller has found their 3rd house" startDate="2022/01/17">
                <p>
            ...
            <TimelineItem title="Too stressful for the seller" startDate="2022/02/03">
                <p>
